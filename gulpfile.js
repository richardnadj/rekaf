...
gulp.task('publish-rekaf-css', function() {
	return gulp.src('dev/css/sass/rekaf.scss')
		.pipe(
			sass({
...
gulp.task('publish', ['clean-live'], function() {
	gulp.start('update-index', 'update-scss', 'publish-css', 'publish-rekaf-css', 'publish-js');
});
